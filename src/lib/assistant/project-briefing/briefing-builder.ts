...
export function buildBriefingDocument(
  ...
  const sections: BriefingExportSection[] = [
    ...
    section("project", "Projektziele", [
      ...
      ["Geschäftsfokus", project.businessFocus],
    ...
    section("requirements", "Anforderungen & Funktionen", [
      ...
      ["Corporate Design", requirements.hasCorporateDesign],
      ["Texte und Bilder", requirements.hasContent],
      ["Domain vorhanden", requirements.hasDomain],
      ["CRM", requirements.hasCrm],
      ["Terminbuchung", requirements.hasAppointmentBooking],
